...
type
  NiflerKind* = enum
    ...
    TupL = (210, "tup")  ## untyped tuple constructor
    TabconstrL = (213, "tabconstr")  ## table constructor
    CallstrlitL = (218, "callstrlit")
    InfixL = (219, "infix")
    PrefixL = (220, "prefix")
    TypeofL = (227, "typeof")
    ExprL = (233, "expr")
    DoL = (234, "do")  ## `do` expression
    StaticstmtL = (254, "staticstmt")  ## `static` statement
    BindL = (255, "bind")  ## `bind` statement
    MixinL = (256, "mixin")  ## `mixin` statement
    UsingL = (257, "using")  ## `using` statement
    AsmL = (258, "asm")  ## `asm` statement
    DeferL = (259, "defer")  ## `defer` statement
