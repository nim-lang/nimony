...
proc trIte(c: var ControlFlow; n: var Cursor; tjmp, fjmp: var FixupList) =
  ...
  of ErrX, SufX, AtX, DerefX, DotX, PatX, AddrX, NilX, InfX, NeginfX,
     ...
     AstToStrX, BindSymX, InstanceofX, ProccallX, HighX, LowX, TypeofX, UnpackX,
...
proc trExpr(c: var ControlFlow; n: var Cursor; tar: var Target) =
  ...
  of ParLe:
    ...
    of CompilesX, DeclaredX, DefinedX, AstToStrX, BindSymX, HighX, LowX, TypeofX, SizeofX, AlignofX, OffsetofX, InternalTypeNameX:
