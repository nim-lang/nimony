...
const macOSImportMap* = block:
  ...
  m["EDEADLK"] = I("11"); m["ENAMETOOLONG"] = I("63"); m["ENOLCK"] = I("77")
  ...
  m["O_SYNC"] = I("0x80"); m["O_DSYNC"] = I("0x400000"); m["O_DIRECTORY"] = I("0x100000")
  m["O_CLOEXEC"] = I("0x1000000"); m["O_NOCTTY"] = I("0x20000")
  ...
  m["SO_ACCEPTCONN"] = I("0x0002"); m["SO_RCVBUF"] = I("0x1002"); m["SO_SNDBUF"] = I("0x1001")
  ...
  m["SIGUSR1"] = I("30"); m["SIGUSR2"] = I("31"); m["SIGVTALRM"] = I("26")
  ...
  m["POLLWRNORM"] = I("4"); m["POLLRDBAND"] = I("128"); m["POLLWRBAND"] = I("0x100")
  # mmap
  ...
  # pthread
  m["PTHREAD_MUTEX_RECURSIVE"] = I("2"); m["PTHREAD_MUTEX_DEFAULT"] = I("0")
  m["PTHREAD_MUTEX_NORMAL"] = I("0"); m["PTHREAD_MUTEX_ERRORCHECK"] = I("1")
  m["PTHREAD_CREATE_JOINABLE"] = I("1"); m["PTHREAD_CREATE_DETACHED"] = I("2")
  m["PTHREAD_PRIO_NONE"] = I("0"); m["PTHREAD_PRIO_INHERIT"] = I("1"); m["PTHREAD_PRIO_PROTECT"] = I("2")
  m["PTHREAD_EXPLICIT_SCHED"] = I("2"); m["PTHREAD_INHERIT_SCHED"] = I("1")
  m["PTHREAD_SCOPE_SYSTEM"] = I("1"); m["PTHREAD_SCOPE_PROCESS"] = I("2")
  m["PTHREAD_PROCESS_PRIVATE"] = I("2"); m["PTHREAD_PROCESS_SHARED"] = I("1")
  m["PTHREAD_CANCEL_ENABLE"] = I("1"); m["PTHREAD_CANCEL_DISABLE"] = I("0")
  m["PTHREAD_CANCEL_DEFERRED"] = I("2"); m["PTHREAD_CANCEL_ASYNCHRONOUS"] = I("0")
  m["PTHREAD_BARRIER_SERIAL_THREAD"] = I("-1")
  # signal actions
  m["SIG_BLOCK"] = I("1"); m["SIG_UNBLOCK"] = I("2"); m["SIG_SETMASK"] = I("3")
  m["SIG_DFL"] = I("0"); m["SIG_IGN"] = I("1")
  ...
  m["SIGEV_NONE"] = I("0"); m["SIGEV_SIGNAL"] = I("1"); m["SIGEV_THREAD"] = I("3")
  # fcntl
  ...
  m["F_RDLCK"] = I("1"); m["F_WRLCK"] = I("3"); m["F_UNLCK"] = I("2")
  # socket
  m["SO_DEBUG"] = I("0x1"); m["SO_DONTROUTE"] = I("0x10"); m["SO_OOBINLINE"] = I("0x100")
  m["SO_SNDLOWAT"] = I("0x1003"); m["SO_RCVLOWAT"] = I("0x1004"); m["SO_BINDTODEVICE"] = I("0x1134")
  ...
  m["WNOWAIT"] = I("0x20"); m["WSTOPPED"] = I("0x8"); m["WUNTRACED"] = I("0x2")
  m["P_ALL"] = I("0"); m["P_PID"] = I("1"); m["P_PGID"] = I("2")
  # sched/clock
  m["SCHED_FIFO"] = I("4"); m["SCHED_OTHER"] = I("1"); m["SCHED_RR"] = I("2")
  m["CLOCK_MONOTONIC"] = I("6"); m["CLOCK_REALTIME"] = I("0")
  m["CLOCK_PROCESS_CPUTIME_ID"] = I("12"); m["CLOCK_THREAD_CPUTIME_ID"] = I("16")
  m["TIMER_ABSTIME"] = I("1")
  # dlopen
  m["RTLD_LAZY"] = I("0x1"); m["RTLD_NOW"] = I("0x2"); m["RTLD_GLOBAL"] = I("0x8"); m["RTLD_LOCAL"] = I("0x4")
  # glob/fnmatch
  m["GLOB_APPEND"] = I("1"); m["GLOB_DOOFFS"] = I("2"); m["GLOB_ERR"] = I("4"); m["GLOB_MARK"] = I("8")
  m["GLOB_NOCHECK"] = I("16"); m["GLOB_NOESCAPE"] = I("0x2000"); m["GLOB_NOSORT"] = I("32")
  m["GLOB_NOSPACE"] = I("-1"); m["GLOB_NOSYS"] = I("-4")
  m["FNM_NOESCAPE"] = I("1"); m["FNM_PATHNAME"] = I("2"); m["FNM_PERIOD"] = I("4"); m["FNM_NOMATCH"] = I("1")
  # ftw
  m["FTW_F"] = I("0"); m["FTW_D"] = I("1"); m["FTW_DNR"] = I("2"); m["FTW_DP"] = I("3")
  m["FTW_NS"] = I("4"); m["FTW_SL"] = I("5"); m["FTW_SLN"] = I("6")
  m["FTW_PHYS"] = I("1"); m["FTW_MOUNT"] = I("2"); m["FTW_CHDIR"] = I("8")
  # locale
  m["LC_ALL"] = I("0"); m["LC_COLLATE"] = I("1"); m["LC_CTYPE"] = I("2"); m["LC_MESSAGES"] = I("6")
  m["LC_MONETARY"] = I("3"); m["LC_NUMERIC"] = I("4"); m["LC_TIME"] = I("5")
  # aio
  m["AIO_ALLDONE"] = I("1"); m["AIO_CANCELED"] = I("2"); m["AIO_NOTCANCELED"] = I("4")
  m["LIO_NOP"] = I("0"); m["LIO_NOWAIT"] = I("1"); m["LIO_READ"] = I("1"); m["LIO_WAIT"] = I("2")
  m["LIO_WRITE"] = I("2")
  # spawn
  m["POSIX_SPAWN_RESETIDS"] = I("1"); m["POSIX_SPAWN_SETPGROUP"] = I("2")
  m["POSIX_SPAWN_SETSIGDEF"] = I("4"); m["POSIX_SPAWN_SETSIGMASK"] = I("8")
  # rlimit
  m["RLIMIT_NOFILE"] = I("8"); m["RLIMIT_STACK"] = I("3")
  # eai
  m["EAI_AGAIN"] = I("2"); m["EAI_BADFLAGS"] = I("3"); m["EAI_FAIL"] = I("4"); m["EAI_FAMILY"] = I("5")
  ...
  m["MS_ASYNC"] = I("0x1"); m["MS_SYNC"] = I("0x10"); m["MS_INVALIDATE"] = I("2")
  ...
  # errno additions
  m["EALREADY"] = I("37"); m["EMULTIHOP"] = I("95"); m["ENOBUFS"] = I("55"); m["ENOLINK"] = I("97")
  # resolver
  m["HOST_NOT_FOUND"] = I("1"); m["TRY_AGAIN"] = I("2"); m["NO_DATA"] = I("4"); m["NO_RECOVERY"] = I("3")
  # nl_types / langinfo
  m["NL_CAT_LOCALE"] = I("1"); m["NL_SETD"] = I("1")
  m["CODESET"] = I("0"); m["NOEXPR"] = I("53"); m["YESEXPR"] = I("52")
  m["RADIXCHAR"] = I("50"); m["THOUSEP"] = I("51"); m["CRNCYSTR"] = I("56")
  m["ALT_DIGITS"] = I("49")
  m
...
const linuxImportMap* = block:
  ...
  m["EPROTO"] = I("71"); m["ENODATA"] = I("61"); m["ENOSR"] = I("63")
  m["ENOSTR"] = I("60"); m["ETIME"] = I("62")
  # fcntl/open
  ...
  m["O_DIRECTORY"] = I("65536"); m["O_CLOEXEC"] = I("0x80000"); m["O_NOCTTY"] = I("256")
  m["O_DIRECT"] = I("16384"); m["O_NOFOLLOW"] = I("0x20000"); m["O_TMPFILE"] = I("0x410000")
  # socket
  ...
  m["SO_RCVBUF"] = I("8"); m["SO_SNDBUF"] = I("7"); m["TCP_NODELAY"] = I("1"); m["SOMAXCONN"] = I("4096")
  m["IPPROTO_TCP"] = I("6"); m["IPPROTO_UDP"] = I("17"); m["IPPROTO_IP"] = I("0")
  m["IPPROTO_ICMP"] = I("1"); m["IPPROTO_ICMPV6"] = I("58"); m["IPPROTO_RAW"] = I("255")
  m["SHUT_RD"] = I("0"); m["SHUT_WR"] = I("1"); m["SHUT_RDWR"] = I("2")
  m["INET_ADDRSTRLEN"] = I("16"); m["INET6_ADDRSTRLEN"] = I("46")
  ...
  m["POLLIN"] = I("1"); m["POLLOUT"] = I("4"); m["POLLERR"] = I("8"); m["POLLHUP"] = I("16")
  m["POLLNVAL"] = I("32"); m["POLLPRI"] = I("2"); m["POLLRDNORM"] = I("64")
  m["POLLWRNORM"] = I("0x100"); m["POLLRDBAND"] = I("128"); m["POLLWRBAND"] = I("0x200")
  # mmap
  m["PROT_READ"] = I("1"); m["PROT_WRITE"] = I("2"); m["PROT_EXEC"] = I("4"); m["PROT_NONE"] = I("0")
  ...
  m["WNOWAIT"] = I("0x01000000"); m["WSTOPPED"] = I("2"); m["WUNTRACED"] = I("2")
  m["P_ALL"] = I("0"); m["P_PID"] = I("1"); m["P_PGID"] = I("2")
  # sched/clock
  ...
  # glob/fnmatch/ftw
  m["GLOB_APPEND"] = I("32"); m["GLOB_DOOFFS"] = I("8"); m["GLOB_ERR"] = I("1"); m["GLOB_MARK"] = I("2")
  m["GLOB_NOCHECK"] = I("16"); m["GLOB_NOESCAPE"] = I("64"); m["GLOB_NOSORT"] = I("4")
  m["GLOB_NOSPACE"] = I("1"); m["GLOB_NOSYS"] = I("4")
  m["FNM_NOESCAPE"] = I("2"); m["FNM_PATHNAME"] = I("1"); m["FNM_PERIOD"] = I("4"); m["FNM_NOMATCH"] = I("1")
  m["FTW_F"] = I("0"); m["FTW_D"] = I("1"); m["FTW_DNR"] = I("2"); m["FTW_DP"] = I("5")
  m["FTW_NS"] = I("3"); m["FTW_SL"] = I("4"); m["FTW_SLN"] = I("6")
  m["FTW_PHYS"] = I("1"); m["FTW_MOUNT"] = I("2"); m["FTW_CHDIR"] = I("4")
  # locale
  m["LC_ALL"] = I("6"); m["LC_COLLATE"] = I("3"); m["LC_CTYPE"] = I("0"); m["LC_MESSAGES"] = I("5")
  m["LC_MONETARY"] = I("4"); m["LC_NUMERIC"] = I("1"); m["LC_TIME"] = I("2")
  # aio
  m["AIO_ALLDONE"] = I("2"); m["AIO_CANCELED"] = I("0"); m["AIO_NOTCANCELED"] = I("1")
  m["LIO_NOP"] = I("2"); m["LIO_NOWAIT"] = I("1"); m["LIO_READ"] = I("0"); m["LIO_WAIT"] = I("0")
  m["LIO_WRITE"] = I("1")
  # spawn
  m["POSIX_SPAWN_RESETIDS"] = I("1"); m["POSIX_SPAWN_SETPGROUP"] = I("2")
  m["POSIX_SPAWN_SETSCHEDPARAM"] = I("0x10"); m["POSIX_SPAWN_SETSCHEDULER"] = I("0x20")
  m["POSIX_SPAWN_SETSIGDEF"] = I("0x04"); m["POSIX_SPAWN_SETSIGMASK"] = I("0x08")
  # rlimit
...
const windowsImportMap* = block:
  ...
  m["EPERM"] = I("1"); m["ENOENT"] = I("2"); m["ESRCH"] = I("3"); m["EINTR"] = I("4")
  m["EIO"] = I("5"); m["ENXIO"] = I("6"); m["E2BIG"] = I("7"); m["ENOEXEC"] = I("8")
  m["EBADF"] = I("9"); m["ECHILD"] = I("10"); m["EAGAIN"] = I("11"); m["EWOULDBLOCK"] = I("140")
  m["ENOMEM"] = I("12"); m["EACCES"] = I("13"); m["EFAULT"] = I("14"); m["EBUSY"] = I("16")
  m["EEXIST"] = I("17"); m["EXDEV"] = I("18"); m["ENODEV"] = I("19"); m["ENOTDIR"] = I("20")
  m["EISDIR"] = I("21"); m["EINVAL"] = I("22"); m["ENFILE"] = I("23"); m["EMFILE"] = I("24")
  m["ENOTTY"] = I("25"); m["EFBIG"] = I("27"); m["ENOSPC"] = I("28"); m["ESPIPE"] = I("29")
  ...
  m["ENOSYS"] = I("40"); m["ENOTEMPTY"] = I("41"); m["ELOOP"] = I("114")
  ...
  m["EISCONN"] = I("113"); m["ENETDOWN"] = I("116"); m["ENETRESET"] = I("117")
  m["ENETUNREACH"] = I("118"); m["ETIMEDOUT"] = I("138"); m["EINPROGRESS"] = I("112")
  # fcntl/open
  m["O_RDONLY"] = I("0"); m["O_WRONLY"] = I("1"); m["O_RDWR"] = I("2"); m["O_ACCMODE"] = I("3")
  m["O_CREAT"] = I("0x100"); m["O_EXCL"] = I("0x400"); m["O_TRUNC"] = I("0x200"); m["O_APPEND"] = I("0x0008")
  # socket
  ...
  m["SEEK_SET"] = I("0"); m["SEEK_CUR"] = I("1"); m["SEEK_END"] = I("2")
  # stdio
  m["_IOFBF"] = I("0"); m["_IOLBF"] = I("0x0040"); m["_IONBF"] = I("0x0004")
