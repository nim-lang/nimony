...
## Parked nifcursors original, superseded on the live path by the nifcore
## `patchsets.nim`. Kept for the legacy passes (`cse`, `copy_propagation`,
## `constant_folding`, `rewriter`, `induction_variables_legacy`) until they are
## revived/ported to nifcore.
##
