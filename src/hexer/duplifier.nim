...
proc constructsValue*(n: Cursor; derefConstructs = true): bool =
  ...
  while true:
    ...
    of ErrX, SufX, AtX, DotX, PatX, ParX, AddrX, NilX, InfX,
        ...
        HcallX, CompilesX, DeclaredX, DefinedX, AstToStrX, BindSymX,
...
proc lvalueRoot(n: Cursor; hdrefs: var bool): SymId =
  ...
  while true:
    ...
    of ErrX, SufX, DerefX, PatX, ParX, AddrX, NilX, InfX, NeginfX,
        ...
        DefinedX, AstToStrX, BindSymX, InstanceofX, ProccallX, HighX, LowX,
  ...
  while true:
    ...
    of ParLe:
      ...
      of ErrX, SufX, AtX, DerefX, DotX, PatX, ParX, AddrX, NilX,
          ...
          AstToStrX, BindSymX, InstanceofX, ProccallX, HighX, LowX, TypeofX,
...
proc tr(c: var Context; n: var Cursor; e: Expects) =
  if n.kind == Symbol:
    ...
    of NilX, FalseX, TrueX, AndX, OrX, NotX, NegX, SizeofX, SetconstrX,
       ...
       DefinedX, AstToStrX, BindSymX, HighX, LowX, TypeofX, UnpackX, FieldsX, FieldpairsX, EnumtostrX, IsmainmoduleX, QuotedX,
