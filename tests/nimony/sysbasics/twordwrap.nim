...
ξχλωωχαοεοιαεοαεοιαεοαεοιαοεσναοεκνρκψγκψφϵιηαααοε"""
assert wrapWords(longlongword) == longlongwordRes
...
assert wrapWords(input60) == input60Res
