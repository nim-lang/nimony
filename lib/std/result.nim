...
##
## `unsafeGet` raises `BadOperation` on the wrong variant (a system `ErrorCode`);
## guard with `isOk`, or use the total `get(default)`.
##
## ```nim
## import std/result
