...
proc getHomeDir*(): string {.tags: [ReadEnvEffect, ReadIOEffect].} =
...
proc getDataDir*(): string {.tags: [ReadEnvEffect, ReadIOEffect].} =
...
proc getConfigDir*(): string {.tags: [ReadEnvEffect, ReadIOEffect].} =
